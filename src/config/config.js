...
const envVarsSchema = Joi.object()
  .keys({
    ...
    PGUSER: Joi.string().required().description('Postgress Username is required!'),
    PGPASSWORD: Joi.string().required().description('Postgress Password is required!'),
    PGHOST: Joi.string().required().description('Postgress Host name is required!'),
    // PG_PORT: Joi.number().required().description('Postgress Port is required!'),
    PGDATABASE: Joi.string().required().description('Postgress Database name is required!'),
    ENDPOINT_ID: Joi.string().required().description('Endpoint required'),
